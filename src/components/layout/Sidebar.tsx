...
export const Sidebar: React.FC<SidebarProps> = () => {
    ...
    return (
        <aside className="w-64 h-full bg-[#09100c] border-r border-green-500/15 flex flex-col justify-between select-none shrink-0">
            {/* Top Navigation Block */}
            <div className="flex flex-col flex-1 min-h-0">
                {/* Logo & Header */}
                <div className="p-4 flex items-center gap-3 border-b border-green-500/10">
                    <img
                        src={logo}
                        alt="Noosphere Reflect Logo"
                        className="w-7 h-7 object-contain drop-shadow-[0_0_8px_rgba(16,185,129,0.3)]"
                        onClick={() => navigate('/')}
                        style={{ cursor: 'pointer' }}
                    />
                    <div className="flex flex-col">
                        <span className="font-bold text-sm tracking-tight bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent">
                            Noosphere Reflect
                        </span>
                                    ...
                                    <div className="absolute right-1 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                                        ...
                                        {activeActionMenuId === chat.id && (
                                            <>
                                                ...
                                                />
                                                <div className="absolute right-0 mt-1 w-44 bg-[#0e1511] border border-green-500/20 rounded-xl shadow-xl py-1 z-50 animate-fade-in text-[11px]">
                                                    <button
            ...
            <div className="p-3 border-t border-green-500/10 relative">
                <button
                    ...
                    className="w-full flex items-center gap-3 p-2 hover:bg-green-500/5 rounded-2xl transition-all text-left"
                >
                    <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-green-500 to-emerald-600 flex items-center justify-center text-[#09100c] font-bold text-xs shadow-[0_0_10px_rgba(16,185,129,0.3)]">
                ...
                {profileMenuOpen && (
                    <>
                        ...
                        <div className="absolute bottom-16 left-3 right-3 bg-[#0e1511] border border-green-500/20 rounded-2xl shadow-xl py-2 z-50 animate-fade-in">
                            <button
                                onClick={() => {
