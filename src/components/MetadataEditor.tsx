...
const MetadataEditor: React.FC<MetadataEditorProps> = ({ metadata, onChange }) => {
    ...
    return (
        <div className="bg-gray-800/40 backdrop-blur border border-gray-700 p-6 rounded-2xl shadow-lg space-y-4">
            <h2 className="text-xl font-bold text-green-400 mb-2">3. Archival Metadata</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        className="w-full bg-gray-900/50 border border-gray-600 rounded-lg p-2 text-gray-200 text-sm focus:ring-2 focus:ring-green-400 focus:border-transparent outline-none transition-all shadow-lg shadow-green-500/5"
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                    {metadata.tags.map(tag => (
                        <span key={tag} className="bg-green-600/20 text-green-400 px-2 py-1 rounded text-xs flex items-center gap-1 border border-green-500/30">
                            #{tag}
