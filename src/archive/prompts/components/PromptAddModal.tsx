...
const PromptAddModal: React.FC<PromptAddModalProps> = ({
    isOpen,
    onClose,
    onSave,
    editingPrompt
    ...
    const accentClasses = 'from-blue-400 to-cyan-600';

    const handleSave = async (content: string, category: string, tags: string[], title?: string) => {
        await onSave(content, category, tags, title);
        onClose();
    };
