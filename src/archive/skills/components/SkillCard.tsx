...
export default function SkillCard({ skill, viewMode = 'grid', isSelectionMode = false, onEdit, onDelete, onExport, onPreview, onMoveToProject, isSelected, onToggleSelect }: Props) {
    ...
    return (
        <div
            ...
            ${isSelected
                    ? 'bg-cyan-900/10 border-cyan-500/50 shadow-lg shadow-cyan-900/10 shadow-cyan-500/20 ring-1 ring-cyan-500/50 scale-[1.03]'
                    : 'bg-[#122622]/20 hover:bg-[#122622]/40 border-gray-600/10 hover:border-cyan-500/30 hover:shadow-cyan-900/5 hover:shadow-cyan-500/10 hover:shadow-lg'
                }`}>
