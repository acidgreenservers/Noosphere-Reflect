            ...
            <div className="relative bg-[#0e1511] w-full max-w-2xl border border-green-500/20 rounded-2xl shadow-2xl p-6 m-4 animate-fade-in flex flex-col max-h-[90vh]">
                <div className="flex items-center justify-between mb-4 shrink-0">
                    <h2 className="text-xl font-bold text-white flex items-center gap-2">
                        <span>🧠</span> Manage project memory
                    </h2>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto mb-4 scrollbar-thin pr-2">
                    <p className="text-sm text-gray-400 mb-4">
                        Information added to project memory is available to the AI across all chats in this project. Use this for key facts, context, or ongoing background details.
                    </p>
                    <textarea
                        value={memory}
