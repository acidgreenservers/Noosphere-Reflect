            ...
            <div className="relative bg-[#0e1511] w-full max-w-2xl border border-green-500/20 rounded-2xl shadow-2xl p-6 m-4 animate-fade-in flex flex-col max-h-[90vh]">
                ...
                <div className="flex-1 overflow-y-auto mb-4 scrollbar-thin pr-2">
                    <p className="text-sm text-gray-400 mb-4">
                        Update the description for this project. This appears in the project list and header.
                    </p>
                    <textarea
                        value={description}
                        onChange={(e) => setDescription(e.target.value)}
                        className="w-full h-32 bg-[#122622]/50 border border-green-500/20 rounded-xl p-4 text-sm text-gray-200 focus:outline-none focus:border-green-500/50 resize-none font-mono"
                        placeholder="Brief description of this project..."
                        maxLength={500}
                    />
                    <p className="text-xs text-gray-600 mt-2 text-right">{description.length}/500</p>
                </div>
