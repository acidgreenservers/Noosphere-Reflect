        ...
        <div className="min-h-screen bg-gray-900 text-gray-100 font-sans selection:bg-green-500/30">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden p-8">
                ...
                <div className="relative z-10 text-center space-y-8 max-w-4xl px-4">
                    ...
                    <h1 className="text-6xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-emerald-500 to-green-600">
            ...
            <section className="py-24 px-4">
                <div className="max-w-2xl mx-auto text-center space-y-6">
                    <h2 className="text-3xl font-bold text-white">Support Noosphere Reflect</h2>
                    ...
                    <div className="flex gap-4 justify-center flex-wrap">
                        <a
                            ...
                            className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white rounded-full font-bold transition-all shadow-lg shadow-green-500/50 hover:shadow-green-500/70 flex items-center gap-2 hover:scale-105"
                        >
                            ☕ Support on Ko-fi
                        </a>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="px-6 py-3 bg-gray-800/80 backdrop-blur-xl border border-gray-700 hover:border-green-500/50 text-white rounded-full font-bold transition-all flex items-center gap-2 hover:scale-105"
                        >
