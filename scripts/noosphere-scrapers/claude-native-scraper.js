...
(function() {
    ...
    function getPageMetadata() {
        ...
        const title = titleEl ? titleEl.innerText : 'Claude Conversation';

        return {
            title: title.replace(` - ${CONFIG.PLATFORM_NAME}`, '').trim() || 'Claude Conversation',
    ...
    function exportAsJSON(messages = null) {
        ...
        const chatData = {
            ...
            exportedBy: {
                ...
                version: 'Claude Native Scraper v2.0',
    ...
    function exportAsMarkdown(messages = null) {
        ...
        msgs.forEach((msg) => {
            ...
            // Handle thoughts if present (Claude pattern)
        ...
        markdown += `*Exported by Noosphere Reflect - Claude Native Scraper v2.0*\n`;
    ...
    function init() {
        ...
        showStatus('✨ Claude Native Scraper ready!', 'success');
