...
(function () {
    ...
    const CONFIG = {
        ...
        PLATFORM_ID: 'gemini',
        PLATFORM_COLOR: '#3b82f6', // Gemini Blue
        SELECTORS: {
    ...
    function exportAsJSON(messages = null) {
        ...
        const chatData = {
            ...
            exportedBy: {
                ...
                version: 'Gemini Native Scraper v2.2',
    ...
    /**
     * Get page title/metadata with Gemini-specific fallback
     */
    ...
    function generateFilename(conversationTitle, format = 'kebab-case', extension = 'md') {
        ...
        const baseName = conversationTitle || 'Gemini_Chat';
        ...
        consoleEl.innerHTML = `
            ...
            <div class="ns-content ns-console-content" id="ns-pane-config" style="display: none;">
                <div class="ns-config-group">
                    ...
                    <input type="text" class="ns-input" id="ns-custom-name" placeholder="Gemini_Export">
                </div>
                <div>
