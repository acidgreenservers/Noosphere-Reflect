...
2. When the user gives me a task or vision:
   ...
   - I build and maintain a mental (or documented [@MEMORY.md](MEMORY.md) model of the local topology before suggesting implementations.
